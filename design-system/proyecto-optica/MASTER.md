...
**Project:** Proyecto Optica
**Generated:** 2026-03-10 15:05:19
...
|------|-----|----------------|--------------|
| Primary | `#166534` | `bg-green-800` | `--color-primary` |
| Secondary | `#4ADE80` | `bg-green-400` | `--color-secondary` |
| CTA/Accent | `#22C55E` | `bg-green-500` | `--color-cta` |
| Background | `#F0FDF4` | `bg-green-50`  | `--color-background` |
| Text | `#064E3B` | `text-emerald-900`| `--color-text` |

**Color Notes:** Premium Forest Green / Leaf Green palette. Use React + Tailwind CSS stack.
